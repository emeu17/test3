...
(5,'cykel5','yellowBike.jpg','En gul cykel helt enkelt',13,9000.0,'vacant',7500,100.1,100.1,NULL,NULL,-1,3),
(6,'cykel6','pinkBike.jpg','En rosa cykel',11,9500.0,'rented',2000,10.1,10.1,NULL,NULL,-1,1),
(7,'cykel7','grayBike.jpg','En grå cykel',12,9500.0,'vacant',200,10.1,10.1,NULL,NULL,-1,1);
...
INSERT INTO customer (userid, firstname, lastname, password, email, cityid, payment, balance, unique_id) VALUES (1, 'Natali', 'Åström', '$2a$10$A3nR1z9LsJnbvKhwuuuThe5S4dt6fDzM/VTv2FddEAKYl2cDMBRtS', 'test@test.se', 2, 'card', 500, 88);
...
INSERT INTO customer (userid, firstname, lastname, password, email, cityid, payment, balance, unique_id) VALUES (3, 'Harald', 'Andersson', '$2a$10$VtbmFuD6v5m3KHujohQZ8.xazF2JziA5uUSinttbKp53JH2EdKPzu', 'test@gmail.com', 3, 'prepaid', 99, 89);
